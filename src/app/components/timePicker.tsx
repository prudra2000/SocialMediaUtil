    ...
    <div>
      <Popover>
        <PopoverTrigger>
          <Button
            variant={"outline"}
            className="justify-start text-left font-normal text-muted-foreground w-fit"
          >
        ...
        <PopoverContent className="flex justify-center items-center">
          <div className="flex flex-col justify-center w-min">
            <Button variant={"outline"} className="rounded-t-full" onClick={incrementHour}>
            ...
            <Button variant={"outline"} className="rounded-b-full" onClick={decrementHour}>
              <FaChevronDown className="h-4 w-4" />
            </Button>
          </div>
          <p className='px-1'>:</p>
          <div className="flex flex-col justify-center w-min">
            <Button variant={"outline"} className="rounded-t-full" onClick={incrementMinute}>
              <FaChevronUp className="h-4 w-4" />
            </Button>
            <div>
              <Input
            ...
            <Button variant={"outline"} className="rounded-b-full" onClick={decrementMinute}>
              <FaChevronDown className="h-4 w-4" />
            </Button>
          </div>
